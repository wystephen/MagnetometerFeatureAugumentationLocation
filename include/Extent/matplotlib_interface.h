//Create by steve in 16-10-13 at 上午10:00
//
...
namespace matplotlibcpp {
    ...
    inline void show() {
        PyObject *res = PyObject_CallObject(detail::_interpreter::get().s_python_function_show,
                                            detail::_interpreter::get().s_python_empty_tuple);
    ...
    namespace detail {
        ...
        struct is_callable_impl<true, T> {
            ...
            test(...); // use a variadic function to make sure (1) it accepts everything and (2) its always the worst match
